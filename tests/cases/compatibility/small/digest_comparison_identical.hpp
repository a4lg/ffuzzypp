...
{
	EXPECT_EQ(100, digest_comparison_t::compare("3:AAAAAAA:", "3:AAAAAAAAAAAAAA:"));
	EXPECT_EQ(100, digest_comparison_t::compare("3::AAAAAAA", "3::AAAAAAAAAAAAAA"));
	EXPECT_EQ(100, digest_comparison_t::compare("3:AAAAAABCCCCCC:", "3:AAABCCC:"));
	...
	EXPECT_EQ(100, digest_comparison_t::compare(
